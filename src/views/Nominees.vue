    ...
    <section
        ...
        <div class="container relative mx-auto">
            <div class="grid grid-cols-1 pb-8 text-center mt-10">
                <h3 class="mb-3 text-4xl leading-normal tracking-wider font-semibold text-white">Meet The Nominees</h3>
            </div><!--end grid-->
        </div><!--end container-->
        ...
        <div class="absolute text-center z-10 bottom-5 start-0 end-0 mx-3">
            <ul class="tracking-[0.5px] mb-0 inline-block">
                ...
                <li class="inline-block uppercase text-[13px] font-bold duration-500 ease-in-out text-white" aria-current="page">Nominees</li>
            </ul>
        </div>
    </section>
    <section class="py-16">
        <div class="container mx-auto">
            ...
            <div class="bg-gray-200 rounded-xl shadow-md overflow-hidden mt-6" v-for="artist in nominees" :key="artist.index">
                <div class="md:flex">
                    <div class="md:flex-shrink-0">
                        <img class="h-48 w-full object-cover md:w-48" :src="artist.artist.photo" :alt="artist.artist.name">
                    </div>
                    <div class="p-8">
                        <h1 class="text-2xl font-bold mb-2">{{ artist.artist.name }}</h1>
                        <p class="text-gray-500 mb-4">Category : {{artist.category.name}}</p>
                        <div class="">
                            <a
                            href="#"
                          ...
                          <a
                            href="#"
                            class="text-white bg-green-900 hover:bg-yellow-700 focus:outline-none focus:ring-4 focus:ring-yellow-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:focus:ring-yellow-900"
                            >Vote For</a
                          >
                        </div>
                    </div>
