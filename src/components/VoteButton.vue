...
<Toast />
  <form @submit.prevent="voteForArtist">
    <button type="submit" class="text-white bg-green-900 hover:bg-yellow-700 focus:outline-none focus:ring-4 focus:ring-yellow-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:focus:ring-yellow-900">Vote</button>
  </form>
</template>
