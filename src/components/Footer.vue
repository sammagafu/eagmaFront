...
<footer class="bg-gray-900 lg:mt-6">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
            <router-link :to="{name:'home'}"><img src="@/assets/eagma.svg" class="h-48 mr-3" alt="EAGMA LOGO" /></router-link>
          </div>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" class="hover:underline">East Africa Gospel Music Awards
</a>. All Rights Reserved.
          </span>
          <div class="flex mt-4 sm:justify-center sm:mt-0">
              <a href="https://web.facebook.com/profile.php?id=61557302621441" target="_blank" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                <i class="pi pi-facebook" style="font-size: 1em"></i>
                  <span class="sr-only">Facebook page</span>
              </a>
              <a href="https://www.instagram.com/eagmaafrica?igsh=MWR0ZjJ2cDk0Ym9ubg%3D%3D&utm_source=qr" target="_blank" class="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
                <i class="pi pi-instagram" style="font-size: 1em"></i>
                  <span class="sr-only">Instagram Page</span>
              </a>
              <a href="https://twitter.com/eagmaafrica" target="_blank" class="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
                <i class="pi pi-twitter" style="font-size: 1em"></i>
                  <span class="sr-only">Twitter page</span>
              </a>
              <a href="https://www.tiktok.com/@eagmaafrica?_t=8ky7TAVQTjC&_r=1" target="_blank" class="text-gray-500 hover:text-gray-900 dark:hover:text-white mx-4">
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="1.5em" height="1.3em" viewBox="0 0 48 48">
